...
public function behaviors()
    ...
    /**
     * Lists all Rapport models.
     * @return mixed
     */
    public function actionIndex()
    {
        $modelUpload = new UploadForm();
        $searchModel = new RapportSearch();
    ...
    /**
     * Displays a single Rapport model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Rapport model.
    ...
    /**
     * Deletes an existing Rapport model.
    ...
    /**
     * Finds the Rapport model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Rapport the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Rapport::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionImport() {
     ...
     public function actionExport() {
        $file = Yii::getAlias('@app/RapportExport.xlsx');
