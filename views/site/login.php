...
<body style="background-color:#F5F5F5">
    ...
    <!-- L'image CETIM !-->
                ...
                <div class="" style="padding-left:265px;">
                    <img src="cetim.png" style="height:100px;width:120px;border-radius:50%;margin-bottom:40px;margin-left:px;padding-left:px;">
                </div>
    <!-- Le message BIENVENUE !-->              
        ...
        <div class="section" style="background-color:">
          ...
          <div class="field" style="padding-left:150px;">
           ...
           <?php 
      if(isset($_SESSION["reponse3"]))
      {
        echo "<pre style='margin-left:120px;color:red;'>";
        echo $_SESSION["reponse3"];
        echo "</pre>";
      }
      if(isset($_SESSION["reponse1"])||isset($_SESSION["reponse2"])){
        echo "<pre style='margin-left:120px;color:red;'>";
        echo $_SESSION["reponse1"];
        echo "</pre>";
        echo "<pre style='margin-left:120px;color:red;'>";
        echo $_SESSION["reponse2"];
        echo "</pre>";
        $_SESSION["reponse2"]="";
        $_SESSION["reponse1"]="";
        $_SESSION["reponse3"]="";
...
<!-- L'image TYPEWRITER !-->
    <div class="column" style="background-color:#F5F5F5">
        <article class="" style=" background-color:;margin-top:50px;margin-right:00px;margin-left:200px;padding-bottom:-5px;">
            <img src="typewriter.jpg" style="width:380px;height:480px;">
        </article>  
    </div>
